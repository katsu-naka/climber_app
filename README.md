...
### ユーザーが抱える課題
- 上司の課題
  - 現状、部下の当日のタスクを毎朝ミーティングで確認しているが、全員のタスクをヒアリングするのに時間がかかってしまう。
  - ミーティングのみでは部下のタスクの内容を全て把握しきれず、後の管理業務でフォードバックが不十分だったり、トラブル対応が後手に回ることがあった。
  - 部下が外出後はタスクに対するフィードバックや質問などのアクションが電話やメールでしかできず、互いのタイミング次第でやり取りに時間がかかってしまう。
  - 部下が帰社後は当日の活動について報告を依頼するが、報告フォーマットが定まっておらず効率的な管理ができていなかった。

- 部下の課題
 - 当日のタスクの打ち合わせや、帰社後の報告業務があり営業業務に割ける時間が減っている。
 - 営業中に遂行中のタスクに問題が発生した場合にメールで上司に報告していたが、タスクについての説明など都度入力しなくてはならず手間だと感じていた。
 - 帰社後の業務報告では本日行った業務をメールやワードに書き起こしていたが、この作業で残業が増えたりと内心煩わしく感じていた。
